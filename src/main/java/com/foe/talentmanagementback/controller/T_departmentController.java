...
public class T_departmentController {
    ...
    public Result<T_department> getDepartmentByManager(@RequestParam("talentId") int talentId) {
    ...
    public Result<T_department> getDepartmentById(@RequestParam("departmentId") int departmentId) {
